...
import com.yorel.muxon.tests.util.ProviderTestUtil;
...
/**
 * Integration tests for datacenter functionality including provider tests. Tests provider API
 * through datacenter API which uses providers.
 */
public class DatacenterTests extends BaseIntegrationTest {
  ...
  public void testCreateMockDatacenter() {
    ...
    Response response =
        ProviderTestUtil.createMockDatacenter(datacenterName, "Test datacenter with mock provider");
  ...
  public void testListDatacenters() {
    ...
    Response createResponse =
        ProviderTestUtil.createMockDatacenter(datacenterName, "Test datacenter for listing");
  ...
  public void testGetDatacenter() {
    ...
    String datacenterName = ProviderTestUtil.generateUniqueDatacenterName();
    Response createResponse =
        ProviderTestUtil.createMockDatacenter(datacenterName, "Test datacenter for get");
    assertStatusCode(createResponse, 201);
    String datacenterId = createResponse.jsonPath().getString("id");
  ...
  public void testUpdateDatacenterSettings() {
    ...
    String datacenterName = ProviderTestUtil.generateUniqueDatacenterName();
    Response createResponse =
        ProviderTestUtil.createMockDatacenter(datacenterName, "Test datacenter for update");
    assertStatusCode(createResponse, 201);
    String datacenterId = createResponse.jsonPath().getString("id");
  ...
  public void testDeleteDatacenter() {
    ...
    String datacenterName = ProviderTestUtil.generateUniqueDatacenterName();
    Response createResponse =
        ProviderTestUtil.createMockDatacenter(datacenterName, "Test datacenter for deletion");
    assertStatusCode(createResponse, 201);
    String datacenterId = createResponse.jsonPath().getString("id");
  ...
  public void testCreateTenantDatacenterGrant() {
    ...
    Response datacenterResponse =
        ProviderTestUtil.createMockDatacenter(datacenterName, "Test datacenter for tenant grant");
  ...
  public void testDeleteTenantDatacenterGrant() {
    ...
    String datacenterName = ProviderTestUtil.generateUniqueDatacenterName();
    Response datacenterResponse =
        ProviderTestUtil.createMockDatacenter(datacenterName, "Test datacenter for grant deletion");
    assertStatusCode(datacenterResponse, 201);
    String datacenterId = datacenterResponse.jsonPath().getString("id");
  ...
  public void testMockProviderType() {
    ...
    String datacenterName = ProviderTestUtil.generateUniqueDatacenterName();
    Response response =
        ProviderTestUtil.createMockDatacenter(datacenterName, "Test mock provider type");

    assertStatusCode(response, 201);
    response.then().body("settings.providerType", equalTo("kvm"));
  ...
  public void testProviderSettingsWithFeatures() {
    ...
    String datacenterName = ProviderTestUtil.generateUniqueDatacenterName();
    Response createResponse =
        ProviderTestUtil.createMockDatacenter(datacenterName, "Test datacenter with features");
    assertStatusCode(createResponse, 201);
    String datacenterId = createResponse.jsonPath().getString("id");
  ...
  public void testMultipleDatacentersWithDifferentProviderTypes() {
    ...
    Response response1 =
        ProviderTestUtil.createMockDatacenter(
            datacenterName1, "Test datacenter 1 with mock provider");
    ...
    Response response2 =
        ProviderTestUtil.createMockDatacenter(
            datacenterName2, "Test datacenter 2 with mock provider");
    ...
    listResponse
        .then()
        .body(
            "items.find { it.id == '%s' }.name".formatted(datacenterId1), equalTo(datacenterName1))
        .body(
            "items.find { it.id == '%s' }.name".formatted(datacenterId2), equalTo(datacenterName2));
  ...
  public void testCreateLibvirtProviderDatacenter() {
    ...
    Response response =
        ProviderTestUtil.createMockDatacenter(
            datacenterName, "Test datacenter with libvirt provider");
  ...
  public void testLibvirtProviderCapabilities() {
    ...
    Response createResponse =
        ProviderTestUtil.createMockDatacenter(
            datacenterName, "Test datacenter for libvirt capabilities");
    assertStatusCode(createResponse, 201);
    String datacenterId = createResponse.jsonPath().getString("id");
  ...
  public void testLibvirtProviderWithMultipleDatacenters() {
    ...
    Response response1 =
        ProviderTestUtil.createMockDatacenter(datacenterName1, "Test libvirt datacenter 1");
    assertStatusCode(response1, 201);
    String datacenterId1 = response1.jsonPath().getString("id");

    Response response2 =
        ProviderTestUtil.createMockDatacenter(datacenterName2, "Test libvirt datacenter 2");
    assertStatusCode(response2, 201);
    String datacenterId2 = response2.jsonPath().getString("id");
    ...
    listResponse
        ...
        .body(
            "items.find { it.id == '%s' }.name".formatted(datacenterId1), equalTo(datacenterName1))
        .body(
            "items.find { it.id == '%s' }.settings.providerType".formatted(datacenterId1),
            equalTo("kvm"))
        .body(
            "items.find { it.id == '%s' }.name".formatted(datacenterId2), equalTo(datacenterName2))
        .body(
            "items.find { it.id == '%s' }.settings.providerType".formatted(datacenterId2),
            equalTo("kvm"));

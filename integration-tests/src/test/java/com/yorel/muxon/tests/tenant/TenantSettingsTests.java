...
/**
 * Integration tests for tenant settings functionality. Tests tenant settings API endpoints
 * including general, security, notifications, and appearance settings.
 */
public class TenantSettingsTests extends BaseIntegrationTest {
  ...
  public void testPatchTenantGeneralSettings() {
    ...
    assertStatusCode(response, 200);
    response.then().body("name", equalTo("Updated Tenant Name"));
  }
  ...
  public void testPatchTenantSecuritySettings() {
    ...
    assertStatusCode(response, 200);
    response.then().body("sessionTimeoutMinutes", equalTo(180));
  }
  ...
  public void testPatchTenantAppearanceSettings() {
    ...
    assertStatusCode(response, 200);
    response.then().body("theme", equalTo("auto"));
  }

...
/**
 * Integration tests for system settings functionality.
 * Tests system settings API endpoints including general, security, notifications, IdP, and appearance settings.
 */
public class SystemSettingsTests extends BaseIntegrationTest {
    ...
    public void testUpdateGeneralSettings() {
        Response response = given()
            ...
            .body("""
                {
                    "name": "Infron Cloud Platform",
                    "description": "Multi-tenant cloud management platform",
                    "contactEmail": "admin@infron.example",
        ...
        assertStatusCode(response, 200);
        response.then()
            .body("name", equalTo("Infron Cloud Platform"))
            .body("description", equalTo("Multi-tenant cloud management platform"))
            .body("contactEmail", equalTo("admin@infron.example"))
    ...
    public void testPatchGeneralSettings() {
        ...
        assertStatusCode(response, 200);
        response.then()
            .body("name", equalTo("Updated Platform Name"));
    }
    ...
    public void testPatchSecuritySettings() {
        ...
        assertStatusCode(response, 200);
        response.then()
            .body("sessionTimeoutMinutes", equalTo(90));
    }
    ...
    public void testUpdateNotificationSettings() {
            ...
            .body("""
                {
                    ...
                    "smtpPort": 587,
                    "smtpUsername": "noreply@infron.example",
                    "smtpPassword": "secret-password",
                    "smtpFromEmail": "noreply@infron.example",
                    "smtpUseTls": true,
        ...
        response.then()
            ...
            .body("smtpUsername", equalTo("noreply@infron.example"))
            .body("smtpFromEmail", equalTo("noreply@infron.example"))
    ...
    public void testSendTestEmail() {
        Response response = given()
            ...
            .body("""
                {
                    "to": "test@example.com",
                    "subject": "Infron Test Email",
                    "body": "This is a test email from Infron"
                }
                """)
            .when()
    ...
    public void testUpdateIdpSettings() {
            ...
            .body("""
                {
                    ...
                    "type": "oidc",
                    "name": "Keycloak",
                    "issuerUrl": "https://keycloak.example.com/realms/infron",
                    "clientId": "infron-client",
                    "clientSecret": "client-secret",
                    "scopes": "openid,profile,email",
                    "autoProvisionUsers": true,
                    "jwksUri": "https://keycloak.example.com/realms/infron/protocol/openid-connect/jwks",
                    "userinfoEndpoint": "https://keycloak.example.com/realms/infron/protocol/openid-connect/userinfo"
                }
                """)
            .when()
        ...
        response.then()
            ...
            .body("issuerUrl", equalTo("https://keycloak.example.com/realms/infron"))
            .body("clientId", equalTo("infron-client"))

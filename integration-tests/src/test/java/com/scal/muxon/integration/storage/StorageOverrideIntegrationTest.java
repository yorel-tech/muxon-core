...
import com.scal.muxon.services.storage.scheduler.StorageOverrideResolver;
...
public class StorageOverrideIntegrationTest {
    ...
    @Autowired
    private StorageOverrideResolver overrideResolver;

    @Autowired
    private StorageOverrideRepository overrideRepository;
    ...
    public void testResolveOverride() {
        ...
        List<ProviderStorageEntity> resolved = overrideResolver.resolveOverride(
            "test-class", "libvirt"
        );
    ...
    public void testResolveOverride_DisabledStorageExcluded() {
        ...
        ProviderStorageEntity pool1 = providerStorageRepository
            .findByProviderTypeAndName("libvirt", "pool1")
            .get(0);

package com.scal.muxon.integration.storage;

import com.scal.muxon.db.model.ProviderStorageEntity;
import com.scal.muxon.db.model.StorageCapabilityMappingEntity;
import com.scal.muxon.db.model.StorageClassEntity;
import com.scal.muxon.db.model.StorageOverrideEntity;
import com.scal.muxon.db.repository.ProviderStorageRepository;
import com.scal.muxon.db.repository.StorageCapabilityMappingRepository;
import com.scal.muxon.db.repository.StorageClassRepository;
import com.scal.muxon.db.repository.StorageOverrideRepository;
import com.scal.muxon.services.storage.scheduler.StorageSchedulerService;
import com.scal.muxon.services.storage.scheduler.SchedulerContext;
...
import com.scal.muxon.CoreServicesApplication;
...
public class StorageSchedulerIntegrationTest {
    ...
    @Autowired
    private StorageSchedulerService schedulerService;
    ...
    @Autowired
    private StorageOverrideRepository storageOverrideRepository;

    @Autowired
    private StorageCapabilityMappingRepository capabilityMappingRepository;
    ...
    public void setup() {
        ...
        createProviderStorage("hdd_pool", "dir", Map.of(
            "performance", "low",
            "media", "hdd",
            "shared", false,
            "redundancy", "none"
        ...
        createProviderStorage("balanced_pool", "lvm-thin", Map.of(
            "performance", "medium",
            "media", "ssd",
            "shared", false,
            "redundancy", "none"
    ...
    public void testScheduleStorage_MatchesCapabilities() {
        ...
        StorageSchedulerService.SchedulingResult result = schedulerService.scheduleStorage(
            "fast-ssd",
            testProviderId,
    ...
    public void testScheduleStorage_DisabledStorageExcluded() {
        ...
        ProviderStorageEntity ssdPool = providerStorageRepository
            .findByProviderIdAndName(testProviderId, "ssd_pool")
            .get(0);

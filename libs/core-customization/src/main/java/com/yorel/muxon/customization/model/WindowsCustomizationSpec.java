...
public class WindowsCustomizationSpec {
  ...
  public WindowsDomainJoin getJoinDomain() {
    return joinDomain;
  }

  public void setJoinDomain(WindowsDomainJoin joinDomain) {
  ...
  public List<String> getFirstLogonCommands() {
    return firstLogonCommands;
  }

  public void setFirstLogonCommands(List<String> firstLogonCommands) {

 ...
 */
package com.yorel.muxon.api.util;

import com.yorel.muxon.api.model.Link;

/**
 * Utility class for creating HATEOAS Link instances. Provides factory methods for common link
 * types.
 */
public final class LinkUtil {
   ...
   */
  public static Link custom(
      String rel, String href, String method, String title, boolean enabled, String reason) {
    return new Link()
        .rel(rel)
        .href(href)

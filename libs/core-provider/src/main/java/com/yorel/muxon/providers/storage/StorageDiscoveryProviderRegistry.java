 ...
 *
 * <p>Manages the registration and lookup of storage discovery providers. Provider modules register
 * their implementations on startup, and the core services use this registry to discover storage
 * from providers.
 */

...
public final class VmQueueCommands {
  ...
  /**
   * Resolve provider console connection details for a running VM. Produced by core-services;
   * orchestrator fills {@code payload} result fields and marks the row completed.
   */

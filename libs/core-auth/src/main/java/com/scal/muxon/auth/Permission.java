...
public enum Permission {
    ...
    PROVIDER_STORAGE_EDIT("provider_storage:edit", "Sync or modify provider storage mappings", Scope.SYSTEM),
    ...
    STORAGE_OVERRIDE_MANAGE("storage_override:manage", "Manage storage class overrides", Scope.SYSTEM),
    ...
    DATACENTER_NETWORK_CAPABILITIES_MANAGE("datacenter_network_capabilities:manage", "Manage datacenter network capabilities", Scope.SYSTEM),

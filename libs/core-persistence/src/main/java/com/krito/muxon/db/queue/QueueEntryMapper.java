...
public final class QueueEntryMapper {
    ...
    private static EntityType convertToModelEntityType(com.krito.muxon.api.enums.EntityType enumType) {
        return EntityType.valueOf(enumType.name());
    }

    private static com.krito.muxon.api.enums.EntityType convertToEntityTypeEnum(EntityType modelType) {

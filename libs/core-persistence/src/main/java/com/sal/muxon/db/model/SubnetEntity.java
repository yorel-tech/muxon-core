...
public class SubnetEntity {
    ...
    public FabricNetworkEntity getFabricNetwork() { return fabricNetwork; }
    public void setFabricNetwork(FabricNetworkEntity fabricNetwork) { this.fabricNetwork = fabricNetwork; }
    ...
    public SubnetStatus getStatus() { return status; }
    public void setStatus(SubnetStatus status) { this.status = status; }
    ...
    public enum SubnetStatus { PENDING, ACTIVE, ERROR, DELETING }
}

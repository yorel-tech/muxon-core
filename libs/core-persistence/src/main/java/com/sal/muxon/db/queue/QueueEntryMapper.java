...
public final class QueueEntryMapper {
    ...
    private static EntityType convertToModelEntityType(com.sal.muxon.api.enums.EntityType enumType) {
        return EntityType.valueOf(enumType.name());
    }

    private static com.sal.muxon.api.enums.EntityType convertToEntityTypeEnum(EntityType modelType) {

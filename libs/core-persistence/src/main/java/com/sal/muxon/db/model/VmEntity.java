...
import com.sal.muxon.api.enums.VmPowerState;
import com.sal.muxon.api.enums.VmStatus;
...
public class VmEntity {
    ...
    // Stack and subnet association (nullable during migration window)
    @Column(name = "stack_id", nullable = true)
    private UUID stackId;

    @Column(name = "subnet_id", nullable = true)
    ...
    public UUID getStackId() { return stackId; }
    public void setStackId(UUID stackId) { this.stackId = stackId; }

    public UUID getSubnetId() { return subnetId; }
    public void setSubnetId(UUID subnetId) { this.subnetId = subnetId; }

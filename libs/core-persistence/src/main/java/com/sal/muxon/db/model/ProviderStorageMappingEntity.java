 ...
 * <p>
 * This entity bridges the gap between user-facing storage classes and
 * provider-specific storage implementations. For example, the "fast-ssd"
 * storage class might map to:
 * <ul>
 ...
 * </p>
 * <p>
 * Multiple providers can support the same storage class, with priority
 * determining selection order. Mappings can be enabled/disabled without deletion.
 * </p>
 */
@Entity

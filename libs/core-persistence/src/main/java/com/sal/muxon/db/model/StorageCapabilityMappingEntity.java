 ...
 * <p>
 * This entity enables translation between Muxon's generic storage capability
 * model and provider-specific terminology. For example:
 * <ul>
 *   <li>Muxon "performance: high" → Libvirt pool_type: ["rbd", "nvme"]</li>
 *   <li>Muxon "performance: high" → Proxmox storage_type: ["rbd", "zfspool"]</li>
 * </ul>
 * </p>
 */
@Entity

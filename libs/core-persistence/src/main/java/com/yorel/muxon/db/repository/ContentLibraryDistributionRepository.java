...
public interface ContentLibraryDistributionRepository
    extends JpaRepository<ContentLibraryDistributionEntity, UUID> {
  List<ContentLibraryDistributionEntity> findByLibraryIdOrderByDatacenterId(UUID libraryId);

  Optional<ContentLibraryDistributionEntity> findByLibraryIdAndDatacenterId(

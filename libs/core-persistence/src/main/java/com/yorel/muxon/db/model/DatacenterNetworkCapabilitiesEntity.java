...
public class DatacenterNetworkCapabilitiesEntity {
  ...
  public boolean isPublicIpSupported() {
    return publicIpSupported;
  }

  public void setPublicIpSupported(boolean publicIpSupported) {
    this.publicIpSupported = publicIpSupported;
  }
  ...
  public boolean isBgpSupported() {
    return bgpSupported;
  }

  public void setBgpSupported(boolean bgpSupported) {
    this.bgpSupported = bgpSupported;
  }

  public boolean isHaGatewaySupported() {
    return haGatewaySupported;
  }

  public void setHaGatewaySupported(boolean haGatewaySupported) {
    this.haGatewaySupported = haGatewaySupported;
  }

  public boolean isVxlanSupported() {
    return vxlanSupported;
  }

  public void setVxlanSupported(boolean vxlanSupported) {
    this.vxlanSupported = vxlanSupported;
  }

  public boolean isMultiRegionSupported() {
    return multiRegionSupported;
  }

  public void setMultiRegionSupported(boolean multiRegionSupported) {
    this.multiRegionSupported = multiRegionSupported;
  }

  public boolean isL7LbSupported() {
    return l7LbSupported;
  }

  public void setL7LbSupported(boolean l7LbSupported) {
    this.l7LbSupported = l7LbSupported;
  }
  ...
  public boolean isDualStackSupported() {
    return dualStackSupported;
  }

  public void setDualStackSupported(boolean dualStackSupported) {
    this.dualStackSupported = dualStackSupported;
  }

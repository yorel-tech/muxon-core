 ...
 *
 * <p>Provides CRUD operations and queries for S3-compatible object storage buckets with soft delete
 * support. Bucket names must be unique within a workspace.
 */

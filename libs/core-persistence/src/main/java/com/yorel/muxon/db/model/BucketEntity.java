 ...
 *
 * <p>Buckets provide object storage for unstructured data such as backups, media files, logs, and
 * archives. Each bucket is S3-compatible and can be accessed using standard S3 APIs and tools.
 *
 * <p>Buckets support versioning, encryption, ACLs, and lifecycle policies (in Enterprise edition)
 * for automatic data tiering and expiration.
 */
@Entity
@Table(
    name = "buckets",

...
@Repository
public interface TenantDatacenterGrantRepository
    extends JpaRepository<TenantDatacenterGrantEntity, UUID> {

  Page<TenantDatacenterGrantEntity> findByTenant_Id(UUID tenantId, Pageable pageable);

  Optional<TenantDatacenterGrantEntity> findByTenant_IdAndDatacenter_Id(

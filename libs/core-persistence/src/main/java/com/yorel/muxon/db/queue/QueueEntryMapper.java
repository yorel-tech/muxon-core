...
public final class QueueEntryMapper {
    ...
    private static EntityType convertToModelEntityType(com.yorel.muxon.api.enums.EntityType enumType) {
        return EntityType.valueOf(enumType.name());
    }

    private static com.yorel.muxon.api.enums.EntityType convertToEntityTypeEnum(EntityType modelType) {

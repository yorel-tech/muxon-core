package com.scal.muxon.initializer.service;

import com.scal.muxon.api.enums.BootstrapStatus;
import com.scal.muxon.api.enums.RoleBindingSubjectType;
import com.scal.muxon.api.enums.RoleScopeType;
import com.scal.muxon.api.enums.TenantStatus;
import com.scal.muxon.common.Constants;
import com.scal.muxon.common.EncryptionUtil;
import com.scal.muxon.db.model.*;
import com.scal.muxon.db.repository.*;
import com.scal.muxon.initializer.config.ApplicationConfig;
import com.scal.muxon.initializer.config.BootstrapConfig;
import com.scal.muxon.services.OidcUserService;
import com.scal.muxon.services.model.OidcUserInfo;
...
import static com.scal.muxon.common.Constants.BOOTSTRAP_STATUS_KEY;
...
public class CoreInitializerService {
    ...
    private static final List<ServiceTemplate> OSS_SERVICES = List.of(
     ...
     */
    public void performOssInitialization(String configPath,
                                         String outputFolder,
                                         String passphrasePath,
                                         String oidcSecretPath,
                                         String dbPasswordPath) throws Exception {
        ...
        String encryptionKey = generateEncryptionKey(
                config.getMuxon().getInstanceName(),
    ...
    public void generateAllApplicationYamls(BootstrapConfig config,
                                           String outputFolder,
    ...
    public void generateApplicationYamlForService(String serviceName,
                                                  String templateFile,
    ...
    private static ApplicationConfig loadApplicationTemplateFromClasspath(String templateFile) throws IOException {
    ...
    private IdentityProviderEntity insertIdentityProvider(BootstrapConfig config, String oidcSecretPath) throws IOException {
        ...
        IdentityProviderProtocol protocolEnum = IdentityProviderProtocol.valueOf(
    ...
    private void insertSystemAdmin(BootstrapConfig config, UUID idpId, String oidcSecretPath) throws IOException {
        ...
        IdpUserEntity savedUser = addUserToIdp(
    ...
    private void insertTenantAndAdmin(BootstrapConfig.TenantConfig tenantConfig,
                                      BootstrapConfig config,
                                      UUID idpId,
                                      String oidcSecretPath) throws IOException {
    ...
    private IdpUserEntity addUserToIdp(String username,
    ...
    private RoleBindingEntity createRoleBinding(String roleName,
                                                UUID subjectId,

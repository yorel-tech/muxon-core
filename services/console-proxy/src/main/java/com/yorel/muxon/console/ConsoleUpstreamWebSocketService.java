...
/**
 * Opens a client WebSocket to Proxmox {@code .../vncwebsocket} (cookie or API-token auth) and
 * relays binary frames to/from the browser session managed by {@link ConsoleWebSocketHandler}.
 */
@Component
public class ConsoleUpstreamWebSocketService {
  ...
  public WebSocket connect(
      ConsoleSessionEntity row, ConsoleProxyProperties properties, WebSocketSession browserSession)

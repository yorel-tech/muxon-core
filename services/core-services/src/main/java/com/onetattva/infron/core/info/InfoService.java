package com.onetattva.infron.core.info;

import com.onetattva.infron.api.dto.InfoResponse;
import com.onetattva.infron.api.dto.LicenseView;
import com.onetattva.infron.api.dto.ModuleView;
import com.onetattva.infron.core.common.Edition;
...
public class InfoService {
    ...
    public InfoService(
            ...
            @Value("${infron.edition:CORE}") String editionValue,
            @Value("${infron.product:Infron}") String productName,
            @Value("${infron.version:unknown}") String version
    ) {

package com.onetattva.infron.core.services.task;

import com.onetattva.infron.api.dto.*;
...
import com.onetattva.infron.db.model.TaskStepEntity;
import com.onetattva.infron.db.model.VmEntity;
import com.onetattva.infron.db.repository.JobRepository;
import com.onetattva.infron.db.repository.TaskLogRepository;
import com.onetattva.infron.db.repository.TaskStepRepository;
import com.onetattva.infron.db.repository.VmRepository;
import com.onetattva.infron.core.services.statemachine.EntityStateMachine;
...
public class TaskOrchestrationService {
    ...
    @Value("${infron.tasks.default-timeout:3600}")
    private int defaultTimeoutSeconds;

    @Value("${infron.tasks.max-logs-per-task:1000}")

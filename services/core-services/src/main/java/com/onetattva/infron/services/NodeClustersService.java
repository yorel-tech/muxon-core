...
public class NodeClustersService {
    ...
    public NodeCluster createNodeCluster(NodeClusterCreate nodeClusterCreate) {
        com.onetattva.infron.db.model.NodeClusterEntity entity = new com.onetattva.infron.db.model.NodeClusterEntity();
        entity.setId(UUID.randomUUID());

        // Set datacenter
        com.onetattva.infron.db.model.DatacenterEntity datacenter = datacenterRepository
        ...
        com.onetattva.infron.db.model.NodeClusterEntity saved = nodeClusterRepository.save(entity);
        return mapEntityToApi(saved);
    }

    public NodeCluster getNodeCluster(UUID clusterId) {
        com.onetattva.infron.db.model.NodeClusterEntity entity = nodeClusterRepository.findById(clusterId)
                .orElseThrow();
    ...
    public NodeClusterList listNodeClusters(Integer page, Integer perPage, String sort, UUID datacenterId,
            String name) {
        List<com.onetattva.infron.db.model.NodeClusterEntity> entities;
    ...
    private NodeCluster mapEntityToApi(com.onetattva.infron.db.model.NodeClusterEntity entity) {

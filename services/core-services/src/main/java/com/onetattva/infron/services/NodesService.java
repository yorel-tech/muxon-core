...
public class NodesService {
    ...
    public Node getNode(UUID nodeId) {
        com.onetattva.infron.db.model.NodeEntity entity = nodeRepository.findById(nodeId)
                .orElseThrow();
    ...
    public NodeList listNodes(Integer page, Integer perPage, String sort, UUID clusterId, UUID datacenterId,
        ...
        List<com.onetattva.infron.db.model.NodeEntity> entities;
    ...
    public java.util.Map<String, String> updateNodeMetadata(UUID nodeId, java.util.Map<String, String> metadata) {
        ...
        com.onetattva.infron.db.model.NodeEntity saved = nodeRepository.save(entity);
    ...
    private Node mapEntityToApi(com.onetattva.infron.db.model.NodeEntity entity) {
        Node api = new Node();

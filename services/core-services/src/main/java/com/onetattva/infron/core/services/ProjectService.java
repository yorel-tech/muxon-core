...
import com.onetattva.infron.api.model.ProjectCreate;
import com.onetattva.infron.api.model.ProjectList;
...
public class ProjectService {
    ...
    @Autowired
    private IdpUserRepository tenantUserRepository;
    ...
    public Project createProject(UUID tenantId, ProjectCreate projectCreate) {
        ...
        entityProject.setStatus(ProjectStatus.ACTIVE);
        if (projectCreate.getOwner() != null) {
            IdpUserEntity owner = tenantUserRepository
    ...
    private ProjectStatus mapApiStatus(Project.StatusEnum status) {

...
public class DatacentersService {
    ...
    @Autowired
    private com.yorel.muxon.services.storage.StorageClassValidationService storageClassValidationService;
    ...
    @Autowired(required = false)
    private com.yorel.muxon.db.repository.DatacenterNetworkCapabilitiesRepository dcNetworkCapabilitiesRepository;

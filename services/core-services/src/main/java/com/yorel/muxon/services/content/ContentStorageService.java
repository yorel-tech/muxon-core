...
public class ContentStorageService {
    ...
    if (body.getIsDefault() != null) {
      if (Boolean.TRUE.equals(body.getIsDefault())) {
        ...
        throw new IllegalArgumentException(
            "Clearing default is not supported; set another storage as default first");
      }
    }
    return converter.toApi(contentStorageRepository.save(entity));
  }
  ...
  public void delete(UUID id) {
    ...
    if (entity.isDefaultStorage()) {
      throw new IllegalArgumentException(
          "Cannot delete the default content storage; designate another as default first");
    }
    if (contentLibraryRepository.countByContentStorageId(id) > 0) {
      throw new IllegalArgumentException(
          "Content storage is still referenced by content libraries");
    }
  ...
  private static void validateConfig(
      ContentStorageType type, com.yorel.muxon.api.model.ContentStorageConfig cfg) {
    if (type == null) {

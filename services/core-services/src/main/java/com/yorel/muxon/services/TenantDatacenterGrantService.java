...
import com.yorel.muxon.api.model.DatacenterFeature;
...
import com.yorel.muxon.api.model.ResourceLimits;
import com.yorel.muxon.api.model.StorageUsage;
...
public class TenantDatacenterGrantService {
  ...
  public TenantDatacenterGrant createTenantDatacenterGrant(
      UUID tenantId, TenantDatacenterGrantCreate create) {
    TenantEntity tenant =
        tenantRepository
            .findById(tenantId)
    ...
    DatacenterEntity datacenter =
        datacenterRepository
            .findById(create.getDatacenterId())
            .orElseThrow(
                () ->
                    new EntityNotFoundException(
                        "Datacenter not found: " + create.getDatacenterId()));

    Optional<TenantDatacenterGrantEntity> existing =
        grantRepository.findByTenant_IdAndDatacenter_Id(tenantId, create.getDatacenterId());
  ...
  public TenantDatacenterGrantList listTenantDatacenters(
    ...
    Page<TenantDatacenterGrantEntity> entityPage =
        grantRepository.findByTenant_Id(tenantId, pageable);
    List<TenantDatacenterGrant> items =
        entityPage.getContent().stream().map(this::mapEntityToGrant).toList();
    ...
    TenantDatacenterGrantEntity entity =
        grantRepository
            ...
            .orElseThrow(
                () ->
                    new EntityNotFoundException(
                        "Tenant datacenter grant not found for tenant "
                            + tenantId
                            + " and datacenter "
                            + datacenterId));
  ...
  public TenantDatacenterGrant replaceTenantDatacenterGrant(
      UUID tenantId, UUID datacenterId, TenantDatacenterGrant grant) {
    TenantDatacenterGrantEntity entity =
        grantRepository
            .findByTenant_IdAndDatacenter_Id(tenantId, datacenterId)
            .orElseThrow(
  ...
  public TenantDatacenterGrant updateTenantDatacenterGrant(
      UUID tenantId, UUID datacenterId, TenantDatacenterGrant grant) {
    TenantDatacenterGrantEntity entity =
        grantRepository
            .findByTenant_IdAndDatacenter_Id(tenantId, datacenterId)
    ...
    if (grant.getEnabledFeatures() != null) {
      entity.setEnabledFeatures(stringsFromFeatures(grant.getEnabledFeatures()));
    }
    if (grant.getOverrideSettings() != null) {
  ...
  public GetTenantDatacenterEffective200Response getTenantDatacenterEffective(
      UUID tenantId, UUID datacenterId) {
    TenantDatacenterGrantEntity grantEntity =
        grantRepository
            .findByTenant_IdAndDatacenter_Id(tenantId, datacenterId)
            .orElseThrow(
                () ->
    ...
    DatacenterSettings effectiveSettings =
        mergeEffectiveSettings(dcEntity.getSettings(), grantEntity.getOverrideSettings());

    GetTenantDatacenterEffective200Response response =
        new GetTenantDatacenterEffective200Response();
  ...
  private void applyCreateToEntity(
      TenantDatacenterGrantCreate create, TenantDatacenterGrantEntity entity) {
    entity.setAccess(create.getAccess() != null ? create.getAccess() : true);
    entity.setLimits(toMap(create.getLimits()));
    entity.setEnabledFeatures(
        create.getEnabledFeatures() != null
            ? stringsFromFeatures(create.getEnabledFeatures())
            : null);
  ...
  private void applyGrantToEntity(TenantDatacenterGrant grant, TenantDatacenterGrantEntity entity) {
    ...
    entity.setEnabledFeatures(
        grant.getEnabledFeatures() != null
            ? stringsFromFeatures(grant.getEnabledFeatures())
            : null);
    entity.setOverrideSettings(grant.getOverrideSettings());
  }
  ...
  private static DatacenterSettings mergeEffectiveSettings(
      DatacenterSettings base, DatacenterSettings override) {
    ...
    if (override.getStorageClasses() != null) {
      result.setStorageClasses(override.getStorageClasses());
    }
    if (override.getNetworkDomains() != null) {
      result.setNetworkDomains(override.getNetworkDomains());
    }
    if (override.getProviderSpecificSettings() != null) {
      result.setProviderSpecificSettings(override.getProviderSpecificSettings());
    }
    return result;
  }
  ...
  private ResourceLimits fromMap(Map<String, Object> value) {
    ...
    try {
      ...
      throw new IllegalStateException(
          "Failed to deserialize tenant datacenter grant limits JSON", e);
    }
  }

  public java.util.Map<String, StorageUsage> getStorageUsageByClass(
      UUID tenantId, UUID datacenterId) {
    java.util.Map<String, Long> limits =
        storageClassValidationService.getStorageClassLimits(tenantId, datacenterId);

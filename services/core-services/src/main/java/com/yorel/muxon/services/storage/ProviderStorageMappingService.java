...
import com.yorel.muxon.api.model.MappedStorageClassInfo;
...
public class ProviderStorageMappingService {
  ...
  public MappingBatchContext loadBatchContext() {
    return new MappingBatchContext(
        storageClassRepository.findAll(), storageOverrideRepository.findAll());
  }
  ...
  private static boolean overrideMatchesStorage(
      StorageOverrideEntity o, ProviderStorageEntity storage) {
  ...
  public record MappingBatchContext(
      List<StorageClassEntity> storageClasses, List<StorageOverrideEntity> allOverrides) {

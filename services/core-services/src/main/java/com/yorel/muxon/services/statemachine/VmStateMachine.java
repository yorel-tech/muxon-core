...
import com.yorel.muxon.api.enums.VmOperation;
...
public class VmStateMachine {
  ...
  static {
    VALID_TRANSITIONS.put(
        VmStatus.PENDING, Set.of(VmStatus.PLANNED, VmStatus.ERROR, VmStatus.DELETED));
    VALID_TRANSITIONS.put(
        VmStatus.PLANNED, Set.of(VmStatus.PROVISIONING, VmStatus.ERROR, VmStatus.DELETED));
    VALID_TRANSITIONS.put(
        VmStatus.PROVISIONING, Set.of(VmStatus.ACTIVE, VmStatus.ERROR, VmStatus.DELETING));
    VALID_TRANSITIONS.put(
        VmStatus.ACTIVE,
        Set.of(
            VmStatus.STOPPED,
            ...
            VmStatus.ERROR));
    VALID_TRANSITIONS.put(
        VmStatus.STOPPED, Set.of(VmStatus.ACTIVE, VmStatus.DELETING, VmStatus.ERROR));
    VALID_TRANSITIONS.put(
        VmStatus.SUSPENDED, Set.of(VmStatus.ACTIVE, VmStatus.DELETING, VmStatus.ERROR));
    VALID_TRANSITIONS.put(
        VmStatus.ERROR, Set.of(VmStatus.DELETING, VmStatus.ACTIVE, VmStatus.STOPPED));
    ...
    BLOCKED_OPERATIONS.put(
        ...
        Set.of(
            ...
            VmOperation.RESIZE));
    BLOCKED_OPERATIONS.put(
        VmStatus.ACTIVE, Set.of(VmOperation.CREATE, VmOperation.START, VmOperation.RESUME));
    BLOCKED_OPERATIONS.put(
        VmStatus.STOPPED,
        Set.of(
            VmOperation.CREATE,

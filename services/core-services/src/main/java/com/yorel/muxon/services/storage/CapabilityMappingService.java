 ...
 * For example, Muxon's "performance: high" maps to:
 * <ul>
...
public class CapabilityMappingService {
     ...
     * <p>
     * Takes generic Muxon capabilities and returns provider-specific
    ...
    public Map<String, Object> translateToProviderCapabilities(
        ...
        log.debug("Translated Muxon capabilities {} to provider {} capabilities: {}", 
            muxonCapabilities, providerType, providerCapabilities);
     ...
     * <p>
     * Takes provider-specific capabilities and returns generic Muxon
    ...
    public Map<String, Object> translateFromProviderCapabilities(
        ...
        log.debug("Translated provider {} capabilities {} to Muxon capabilities: {}", 
            providerType, providerCapabilities, muxonCapabilities);
    ...
    /**
     * Reverse translate a provider value to Muxon value.
     * Searches through value mappings to find which Muxon value maps to the provider value.
     */
     ...
     * <p>
     * Determines Muxon capabilities based on provider storage type.

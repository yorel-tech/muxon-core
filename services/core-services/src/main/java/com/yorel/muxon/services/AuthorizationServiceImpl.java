...
public class AuthorizationServiceImpl implements AuthorizationService {
  ...
  /**
   * True if this role binding grants access to APIs under the given tenant: explicit tenant
   * membership, a tenant-global template role, or a system (platform) role.
   */
  ...
  public boolean isAllowed(
      UserPrincipal user, String action, Scope resourceScope, Object resource) {
    // fetch cached perms
  ...
  /**
   * Permissions effective for requests scoped to a tenant: roles bound to that tenant, plus
   * tenant-global template roles and system (platform) roles.
   */

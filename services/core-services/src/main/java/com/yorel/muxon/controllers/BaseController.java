...
/**
 * Base controller providing common metadata operations for entities that support metadata.
...
public abstract class BaseController {
  ...
  protected abstract Map<String, String> updateEntityMetadata(
      UUID id, Map<String, String> metadata);
  ...
  protected ResponseEntity<Map<String, String>> updateMetadata(
      UUID id, Map<String, String> metadata) {

...
import com.yorel.muxon.api.StorageClassesApi;
...
import com.yorel.muxon.services.storage.StorageClassesService;
...
public class StorageClassController implements StorageClassesApi {
  ...
  public ResponseEntity<ProviderStorageList> listProviderStorageForStorageClass(
    ...
    List<ProviderStorageEntity> filtered =
        providerStorageRepository.findAll().stream()
  ...
  @Override
  public ResponseEntity<StorageClass> replaceStorageClass(
      String name, StorageClassUpdate storageClassUpdate) {
  ...
  public ResponseEntity<StorageClassOverrides> replaceStorageClassOverrides(
    ...
    return ResponseEntity.ok(
        storageClassesService.replaceStorageClassOverrides(name, storageClassOverrides));
  }

  @Override
  public ResponseEntity<StorageClass> updateStorageClass(
      String name, StorageClassUpdate storageClassUpdate) {

...
import com.scal.muxon.api.model.ContentStorageType;
...
public class ContentStorageService {
    ...
    private static void validateConfig(ContentStorageType type, com.scal.muxon.api.model.ContentStorageConfig cfg) {
        if (type == null) {

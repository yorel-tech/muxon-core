...
import com.scal.muxon.api.TenantDatacentersApi;
import com.scal.muxon.api.model.GetTenantDatacenterEffective200Response;
import com.scal.muxon.api.model.TenantDatacenterGrant;
import com.scal.muxon.api.model.TenantDatacenterGrantCreate;
import com.scal.muxon.api.model.TenantDatacenterGrantList;
import com.scal.muxon.auth.Permission;
import com.scal.muxon.auth.RequiresAnyPermission;
import com.scal.muxon.auth.RequiresPermission;
import com.scal.muxon.services.TenantDatacenterGrantService;
...
public class TenantDatacentersController implements TenantDatacentersApi {
    ...
    @Override
    @RequiresAnyPermission({Permission.DATACENTER_READ, Permission.TENANT_DATACENTER_READ})
    public ResponseEntity<java.util.Map<String, com.scal.muxon.api.model.StorageUsage>> getTenantStorageUsage(
            UUID tenantId, 
            UUID datacenterId) {
        java.util.Map<String, com.scal.muxon.api.model.StorageUsage> usage = 

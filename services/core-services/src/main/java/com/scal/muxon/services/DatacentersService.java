...
public class DatacentersService {
    ...
    @Autowired
    private com.scal.muxon.services.storage.StorageClassValidationService storageClassValidationService;

    @Autowired(required = false)
    private DatacenterNetworkCapabilitiesService datacenterNetworkCapabilitiesService;

    @Autowired(required = false)
    private com.scal.muxon.db.repository.FabricNetworkRepository fabricNetworkRepository;

    @Autowired(required = false)
    private com.scal.muxon.db.repository.PublicIpPoolRepository publicIpPoolRepository;

    @Autowired(required = false)
    private com.scal.muxon.db.repository.DatacenterNetworkCapabilitiesRepository dcNetworkCapabilitiesRepository;

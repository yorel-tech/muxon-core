...
import com.scal.muxon.db.plugin.PluginLifecycleEvent;
import com.scal.muxon.db.repository.PluginRepository;
import com.scal.muxon.db.repository.ResourceTypeDefinitionRepository;
import com.scal.muxon.services.plugin.PluginManifestValidator.ValidationResult;
...
public class PluginService {
    ...
    private void persistCapabilities(PluginEntity plugin, Map<String, Object> spec) {
        ...
        for (Object capObj : caps) {
            ...
            com.scal.muxon.api.enums.PluginCapabilityType capType = switch (type) {
                case "runtime"           -> com.scal.muxon.api.enums.PluginCapabilityType.RUNTIME;
                case "service"           -> com.scal.muxon.api.enums.PluginCapabilityType.SERVICE;
                case "resource-provider" -> com.scal.muxon.api.enums.PluginCapabilityType.RESOURCE_PROVIDER;
                case "ui-extension"      -> com.scal.muxon.api.enums.PluginCapabilityType.UI_EXTENSION;

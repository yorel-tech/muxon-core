...
public class DatacentersService {
    ...
    @Autowired
    private com.sal.muxon.services.storage.StorageClassValidationService storageClassValidationService;

    @Autowired(required = false)
    private DatacenterNetworkCapabilitiesService datacenterNetworkCapabilitiesService;

    @Autowired(required = false)
    private com.sal.muxon.db.repository.FabricNetworkRepository fabricNetworkRepository;

    @Autowired(required = false)
    private com.sal.muxon.db.repository.PublicIpPoolRepository publicIpPoolRepository;

    @Autowired(required = false)
    private com.sal.muxon.db.repository.DatacenterNetworkCapabilitiesRepository dcNetworkCapabilitiesRepository;

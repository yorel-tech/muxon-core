...
import com.sal.muxon.common.UuidUtils;
import com.sal.muxon.services.model.OidcUserInfo;
import com.sal.muxon.db.model.IdentityProviderEntity;
import com.sal.muxon.db.model.IdpUserEntity;
import com.sal.muxon.db.model.OidcIdentityProviderEntity;
import com.sal.muxon.db.model.OidcMetadata;
import com.sal.muxon.db.model.RoleBindingEntity;
import com.sal.muxon.db.model.UserRoleBindingViewEntity;
import com.sal.muxon.db.repository.IdpUserRepository;
import com.sal.muxon.db.repository.IdentityProviderRepository;
import com.sal.muxon.db.repository.RoleBindingRepository;
...
public class UsersService {
    ...
    private RoleBindingList persistBulkRoleBindings(RoleBindingBulkCreate request) {
        ...
        result.setItems(saved.stream().map(this::mapRoleBindingEntityToApi).collect(Collectors.toList()));
    ...
    private static void validateBindingCreateItem(RoleBindingCreateItem item) {
        ...
        if (RoleBindingCreateItem.ScopeTypeEnum.TENANT.equals(item.getScopeType()) && item.getScopeId() == null) {
            throw new RuntimeException("scope_id is required for TENANT scope");
        }
        if (RoleBindingCreateItem.ScopeTypeEnum.SYSTEM.equals(item.getScopeType()) && item.getScopeId() != null) {
    ...
    private RoleBinding mapRoleBindingEntityToApi(RoleBindingEntity entity) {
        ...
        b.setExpiresAt(entity.getExpiresAt() != null ? entity.getExpiresAt().atOffset(ZoneOffset.UTC) : null);

...
import com.sal.muxon.api.model.ContentStorageType;
...
public class ContentStorageService {
    ...
    private static void validateConfig(ContentStorageType type, com.sal.muxon.api.model.ContentStorageConfig cfg) {
        if (type == null) {

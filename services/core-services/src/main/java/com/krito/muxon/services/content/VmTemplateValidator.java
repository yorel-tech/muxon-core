...
import com.krito.muxon.api.model.VmTemplateDiskSpec;
...
public class VmTemplateValidator {
    ...
    public void validate(VmTemplateSpec spec) {
        ...
        if (spec.getSpec().getCloudInit() == null || spec.getSpec().getCloudInit().getEnabled() == null) {
            throw new IllegalArgumentException("templateSpec.spec.cloudInit.enabled is required");
        }

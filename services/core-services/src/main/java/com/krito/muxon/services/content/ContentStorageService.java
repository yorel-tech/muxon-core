...
import com.krito.muxon.api.model.ContentStorageType;
...
public class ContentStorageService {
    ...
    private static void validateConfig(ContentStorageType type, com.krito.muxon.api.model.ContentStorageConfig cfg) {
        if (type == null) {

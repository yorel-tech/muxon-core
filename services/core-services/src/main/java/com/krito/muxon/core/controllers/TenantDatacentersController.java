...
import com.krito.muxon.api.TenantDatacentersApi;
import com.krito.muxon.api.model.GetTenantDatacenterEffective200Response;
import com.krito.muxon.api.model.TenantDatacenterGrant;
import com.krito.muxon.api.model.TenantDatacenterGrantCreate;
import com.krito.muxon.api.model.TenantDatacenterGrantList;
import com.krito.muxon.core.auth.Permission;
import com.krito.muxon.core.auth.RequiresAnyPermission;
import com.krito.muxon.core.auth.RequiresPermission;
import com.krito.muxon.core.services.TenantDatacenterGrantService;
...
public class TenantDatacentersController implements TenantDatacentersApi {
    ...
    @Override
    @RequiresAnyPermission({Permission.DATACENTER_READ, Permission.TENANT_DATACENTER_READ})
    public ResponseEntity<java.util.Map<String, com.krito.muxon.api.model.StorageUsage>> getTenantStorageUsage(
            UUID tenantId, 
            UUID datacenterId) {
        java.util.Map<String, com.krito.muxon.api.model.StorageUsage> usage = 

 ...
 *
 * <p>Extracts supported CPU types, disk types, network models, and resource limits from Libvirt
 * capabilities output.
 */
public class LibvirtCapabilitiesParser {
  ...
  public static LibvirtCapabilities parse(String capabilitiesXml) {
    try {
        ...
        if (disk != null) {
          ...
          if (maxStorage != null && !maxStorage.isEmpty()) {
            try {
              ...
              caps.setMaxStorageGb(
                  (int) (maxStorageBytes / (1024L * 1024 * 1024L))); // Convert to GB
            } catch (NumberFormatException e) {
      ...
      logger.debug(
          "Parsed Libvirt capabilities: arch={}, hypervisorType={}, maxMemoryMb={}, maxStorageGb={}, maxVms={}, maxCpuCores={}, supportedCpuTypes={}, supportedDiskTypes={}, supportedNetworkModels={}",
          caps.getArch(),
          caps.getHypervisorType(),
          caps.getMaxMemoryMb(),
          caps.getMaxStorageGb(),
          caps.getMaxVms(),
          caps.getMaxCpuCores(),
          caps.getSupportedCpuTypes(),
          caps.getSupportedDiskTypes(),
          caps.getSupportedNetworkModels());

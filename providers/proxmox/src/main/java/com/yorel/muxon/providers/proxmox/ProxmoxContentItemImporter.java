...
/**
 * Resolves Proxmox/KVM-style relative paths under a storage pool for content library items. Wire
 * with {@code muxon.instanceName} / {@code muxon.instanceId} from the host application.
 */
